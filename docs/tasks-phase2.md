...
- [x] **P2 — `phase2/pricing.py`** *(critical, TDD)*
...
- [x] **P4 — `phase2/inventory.py`** *(critical, TDD)*
...
- [x] **P5 — `phase2/strategy.py`** *(critical, TDD)*
...
- [x] **P6 — Maker executor (`common/execution` maker path)**
...
- [x] **P7 — Client extensions (`gamma` end date + `clob` maker orders)**
...
- [x] **P8 — `common/execution` live maker** *(double flag-guarded)*
...
- [x] **P10 — Quote log + analysis script**
